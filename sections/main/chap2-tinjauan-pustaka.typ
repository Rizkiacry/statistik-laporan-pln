...
Untuk mengestimasi parameter $a$, $b$, dan $c$, digunakan metode Kuadrat Terkecil (_Ordinary Least Squares - OLS_) dengan rumus berikut #cite(<s26>):
...
Rumus untuk mencari $R^2$ #cite(<s29>):
...
Interpretasi nilai $R^2$ secara umum #cite(<s30>):
