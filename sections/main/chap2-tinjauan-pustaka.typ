...
Untuk mengestimasi parameter $a$, $b$, dan $c$, digunakan metode Kuadrat Terkecil (_Ordinary Least Squares - OLS_) dengan rumus berikut #cite(<s16>):
...
Interpretasi nilai $R^2$ secara umum:
